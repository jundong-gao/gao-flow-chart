...
var script$1 = {
  ...
  computed: {
    flowItemStyle() {
      let item = this.item;
      let backgroundImage = `url(${item.item_info && item.item_info.icon})`;
      if (item.item_info.type == 'switch') {
        if (item.item_info.switch_status) backgroundImage = `url(${item.item_info && item.item_info.active_icon})`;
      }
      return {
        backgroundImage
      };
...
/* scoped */
const __vue_scope_id__$1 = "data-v-cee6866a";
/* module identifier */
...
var script = {
  ...
  computed: {
    detailStyle() {
      return {
        ...this.options.detail,
        width: `${this.options.detail && this.options.detail.width}px`,
        height: `${this.options.detail && this.options.detail.height}px`,
        zoom: this.zoom
      };
    }
  },
  ...
  methods: {
    init() {
      jsplumb.jsPlumb.ready(() => {
        this.djinstance = jsplumb.jsPlumb.getInstance({
...
/* scoped */
const __vue_scope_id__ = "data-v-4f809de8";
/* module identifier */
